...
namespace ShoppingListApp.Data.Migrations
{
    ...
    [Migration("20260718105836_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ShoppingListApp.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ShoppingListApp.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ShoppingListApp.Models.ShoppingList", b =>
                {
                    b.HasOne("ShoppingListApp.Models.ApplicationUser", "User")
            ...
            modelBuilder.Entity("ShoppingListApp.Models.ShoppingListItem", b =>
                {
                    ...
                    b.HasOne("ShoppingListApp.Models.ShoppingList", "ShoppingList")
                        .WithMany("Items")
